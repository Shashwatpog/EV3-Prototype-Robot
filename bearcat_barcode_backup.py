...
time.sleep(1)
read_color()
forward.on_for_seconds(SpeedPercent(-25),SpeedPercent(-25),0.6/speed)
time.sleep(1)
read_color()
forward.on_for_seconds(SpeedPercent(-25),SpeedPercent(-25),0.6/speed)
time.sleep(1)
...
display.update()
display.text_pixels(code_read, clear_screen = False, x = 0, y = 50, text_color='black',font = None)
display.update()
time.sleep(10)
sound.speak("MISSION ACCOMPLISHED")
